...
class thesisDB1 extends Seeder
{
    /**
    ...
    public function run()
    {
		...
		Thesis::create( [
		'type'=>1,
		'clasification'=>'TESIS 023 FISI',
		'title'=>'Sistema de costeo basado en actividades: una herramienta de toma de decisiones',
		'year'=>'2002',
		'school_id'=>1,
		'stand_id'=>1,
		] );
		...
		Thesis::create( [
		'type'=>1,
		'clasification'=>'TESIS 027 FISI',
		'title'=>'Apoyando la Toma de Decisiones en los Procesos de Selección de Adquisiciones y Contrataciones de las Empresas del Estado; Consucode',
		'year'=>'2002',
		'school_id'=>1,
		'stand_id'=>1,
		] );
		...
		Thesis::create( [
		'type'=>1,
		'clasification'=>'TESIS 024 FISI',
		'title'=>'Implementacion de la Red Privada Virtual en Federal Express Corp. a Nivel de Sudamerica',
		'year'=>'2002',
		'school_id'=>1,
		'stand_id'=>1,
		] );
		...
		Thesis::create( [
		'type'=>1,
		'clasification'=>'TESIS 735 FISI',
		'title'=>'Integración d datos Médicos de Hospitales Peruanos mediante un Sistema Mediador de Consultas y un Portal Web',
		'year'=>'2014',
		'school_id'=>1,
		'stand_id'=>1,
		] );
		...
		Thesis::create( [
		'type'=>1,
		'clasification'=>'TESIS 028 FISI',
		'title'=>'Plan Estrategico Informatico',
		'year'=>'2002',
		'school_id'=>1,
		'stand_id'=>1,
		] );
		...
		Thesis::create( [
		'type'=>1,
		'clasification'=>'TESIS 034 FISI',
		'title'=>'Planeamiento Estrategico de la Clinica del Cabello y la Piel',
		'year'=>'2002',
		'school_id'=>1,
		'stand_id'=>1,
		] );
		...
		Thesis::create( [
		'type'=>1,
		'clasification'=>'TESIS 030 FISI',
		'title'=>'Diseño de un Sistema Administrador de Tienda Virtual',
		'year'=>'2002',
		'school_id'=>1,
		'stand_id'=>1,
		] );
		...
		Thesis::create( [
		'type'=>1,
		'clasification'=>'TESIS 033 FISI',
		'title'=>'Sistema Industrial Automatizado de Empaque',
		'year'=>'2002',
		'school_id'=>1,
		'stand_id'=>1,
		] );
		...
		Thesis::create( [
		'type'=>1,
		'clasification'=>'TESIS 031 FISI',
		'title'=>'Papel de los Sistemas de Información en la investigación de Mercado de Empresas de Servicios',
		'year'=>'2002',
		'school_id'=>1,
		'stand_id'=>1,
		] );
		...
		Thesis::create( [
		'type'=>1,
		'clasification'=>'TESIS 039 FISI',
		'title'=>'Proyecto de Implementación de un Datamart en la Empresa Coltur S.A para Apoyar la Toma de Decisiones sobre Servicio al Cliente',
		'year'=>'2003',
		'school_id'=>1,
		'stand_id'=>1,
		] );
		...
		Thesis::create( [
		'type'=>1,
		'clasification'=>'TESIS 038 FISI',
		'title'=>'Sistema para El Gestión Del Transporte Urbano para La Municipal de Lima  Metropolitana',
		'year'=>'2003',
		'school_id'=>1,
		'stand_id'=>1,
		] );
		...
		Thesis::create( [
		'type'=>1,
		'clasification'=>'TESIS 040 FISI',
		'title'=>'Diagnostico de Fallas en Equipos de Computo \"SEDFEC\"',
		'year'=>'2003',
		'school_id'=>1,
		'stand_id'=>1,
		] );
