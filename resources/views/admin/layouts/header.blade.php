<nav class="navbar navbar-default navbar-static-top m-b-0">
    <div class="navbar-header">
        ...
        <ul class="nav navbar-top-links navbar-right pull-right">
            ...
            <li class="dropdown">
                <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img @if(Auth::User()->userSpecification->urlImg!=null) src="{{ asset('imgUsuarios/'.Auth::User()->userSpecification->urlImg) }}" @else src="{{ asset('plugins/images/users/pawandeep.jpg') }}" @endif alt="user-img" width="36" class="img-circle"><b class="hidden-xs">{{ Auth::User()->name }}</b><span class="caret"></span> </a>
                <ul class="dropdown-menu dropdown-user animated flipInY">
                    <li>
                        <div class="dw-user-box">
                            <div class="u-img"><img @if(Auth::User()->userSpecification->urlImg!=null) src="{{ asset('imgUsuarios/'.Auth::User()->userSpecification->urlImg) }}" @else src="{{ asset('plugins/images/users/pawandeep.jpg') }}" @endif alt="user" /></div>
                            <div class="u-text"><h4>{{ Auth::User()->name }}</h4><p class="text-muted">{{ Auth::User()->code }}</p><a href="profile.html" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                        </div>
                    </li>
