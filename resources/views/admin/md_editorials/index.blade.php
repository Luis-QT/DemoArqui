    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            @if($errors->has('name2') && $errors->has('categoria2'))
               $("#div-edit").load('{{ url("/admin/editorials/") }}/{{old("id")}}/edit/4');
            ...
            @elseif($errors->has('name2') && $errors->first('name2')!="name2 ya ha sido registrado.")
                ...
                $("#div-edit").load('{{ url("/admin/editorials/") }}/{{old("id")}}/edit/1/{{old("name2")}},'+cadena);
            @elseif($errors->has('categoria2'))

                $("#div-edit").load('{{ url("/admin/editorials/") }}/{{old("id")}}/edit/2/{{old("name2")}}');
            @else
                var cadena="";
                @if(old('categoria2')!=null)
                ...
                @endforeach
                @endif
                $("#div-edit").load('{{ url("/admin/editorials/") }}/{{old("id")}}/edit/3/{{old("name2")}},'+cadena);
            @endif
