    ...
    <div class="panel-wrapper collapse in" aria-expanded="true">
        <div class="panel-body">
            <form role="form" method="POST"
				action="{{ url('/admin/editorials/update/'.$editorial->id) }}" name="formulario_editar_editorial">
...
@if($error=="3")
    <script type="text/javascript">
    	$(document).ready(function() {
    		...
    		swal("¡Operación inválida!", "Ya existe una editorial con el nombre {{$nombre}}, por favor introduzca otro nombre.")
