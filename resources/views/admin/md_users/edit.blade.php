                  ...
                  @if($user ==null)
                   ...
                   <form data-toggle="validator" id="formEditUser" action="#" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                  <div class="row">
                                      <div class="form-group col-sm-4">
                                        ...
                                        <input type="text" name="name" class="form-control" value="{{$user->name}}" id="editNameUser" placeholder="Nombre" required>
                                        <div class="help-block with-errors"></div>
                                      </div>
                                      <div class="form-group col-sm-4">
                                        <label for="editLastNameUser" class="control-label">Apellidos (*)</label>
                                        <input type="text" name="lastname" class="form-control" value="{{$user->lastName}}" id="editLastNameUser" placeholder="Apellido" required>
                                        <div class="help-block with-errors"></div>
                                      </div>
                                      <div class="form-group col-sm-4">
                              ...
                              <div class="form-group">
                                  <div class="row">
                                      <div class="form-group col-sm-5">
                                        ...
                                        <input type="text" data-toggle="validator" name="dni" data-mask="99999999" value="{{$user->dni}}" class="form-control" id="editDniUser" placeholder="XXXXX" required>
                                        <div class="help-block with-errors"></div>
                                      </div>
                                      <div class="form-group col-sm-7">
                                        <label for="editInsEmailUser" class="control-label">Correo Inst. (*)</label>
                                        <input type="email" data-toggle="validator"  name="instEmail" value="{{$user->instEmail}}" class="form-control" id="editInsEmailUser" placeholder="XXXXX" required>
                                        <div class="help-block with-errors"></div>
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="form-group">
                                <div class="row">
                                  <div class="form-group col-sm-12">
                                    ...
                                    <input type="file" name="urlImgEdit" data-height="200" data-default-file="{{ asset('imgUsuarios/'.$user->userSpecification->urlImg) }}" id="urlImgEdit" class="dropify" /> </div>
                                  </div>
                              </div>
                              ...
                              <div class="form-group" id="form-group-lector">
                                  <div class="row">
                                      <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" name="code" data-toggle="validator" class="form-control" value="{{$user->code}}" id="editCodeUser" placeholder="XXXXX" required>
                                        <div class="help-block with-errors"></div>
                                      </div>
                                      <div class="form-group col-sm-6">
                                        <label for="editSchoolUser" class="control-label">Escuela (*)</label>
                                          <select name="school" data-toggle="validator" value="{{$user->school->name}}" id="editSchoolUser"	class="select2 form-control" required>
                              ...
                              <div class="form-group">
                                  <div class="row">
                                      <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" name="phone" data-mask="999-9999" class="form-control" value="{{$user->userSpecification->phone}}" id="editPhoneUser" placeholder="XXXXX" >
                                        <div class="help-block with-errors"></div>
                                      </div>
                                      <div class="form-group col-sm-6">
                                        <label for="editCellPhoneUser" class="control-label">Celular </label>
                                        <input type="text" name="cellPhone" data-mask="999999999" value="{{$user->userSpecification->cellPhone}}" class="form-control" id="editCellPhoneUser" placeholder="XXXXX" >
                                        <div class="help-block with-errors"></div>
                                      </div>
                                  </div>
                              </div>
                              <div class="form-group">
                                  <div class="row">
                                      <div class="form-group col-sm-6">
                                        ...
                                        <input type="email" name="personalEmail" class="form-control" value="{{$user->userSpecification->personalEmail}}" id="editPersonalEmailUser" placeholder="XXXXX" >
                                        <div class="help-block with-errors"></div>
                                      </div>
                                      <div class="form-group col-sm-6">
                                        <label for="editAddressUser" class="control-label">Dirección</label>
                                        <input type="text" name="address" class="form-control" value="{{$user->userSpecification->address}}" id="editAddressUser" placeholder="XXXXX">
                                        <div class="help-block with-errors"></div>
                                      </div>
                                  </div>
                              </div>
                    ...
                    <div class="footer-boton">
                      <button id="btnEditarUsuario" data-id="{{$user->id}}" type="button" class="fcbtn btn btn-outline btn-primary btn-1e"> <i class="fa fa-envelope-o m-r-5"></i> <span>Guardar</span></button>
                    </div>
                  </form>
                @endif
                </div>
    ...
    <script type="text/javascript" src="{{ asset('js/admin/users/users_edit.js') }}"></script>
